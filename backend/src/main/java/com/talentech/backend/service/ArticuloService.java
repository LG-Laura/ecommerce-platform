...
import com.talentech.backend.repository.ArticuloRepository;
...
public class ArticuloService {
    ...
    public List<Articulo> obtenerArticulosConStock() {
        ...
        return articuloRepository.findByActivoTrueAndStockGreaterThan(0);
    }
    ...
    public List<Articulo> obtenerArticulosOrdenadosPorPrecioAsc() {
        return articuloRepository.findAllByOrderByPrecioAsc(); // ✔️ Correcto
    }

    // Ordenados por precio de mayor a menor
    public List<Articulo> obtenerArticulosOrdenadosPorPrecioDesc() {
        return articuloRepository.findAllByOrderByPrecioDesc(); // ✔️ Correcto
    }
